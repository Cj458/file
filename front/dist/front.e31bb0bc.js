...
var uploadFile = function uploadFile(file) {
  var apiUrl = 'http://127.0.0.1:8000/api/upload/';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 7;
          return uploadFile(_fileInput.files[0]);
        case 7:
        ...
        case 11:
          ...
          if (_context.t0.response) alert(_context.t0.response.data.file[0], 'danger');else if (_context.t0.request) alert('Could not reach the server!', 'danger');else alert('An unexpected error occurred!', 'danger');
        case 14:
...
var showFilesButton = document.querySelector('#showFiles');
var isFileListVisible = false;
var toggleFileList = function toggleFileList() {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          apiUrl = 'http://127.0.0.1:8000/api/files';
          _context2.prev = 3;
          _context2.next = 6;
        ...
        case 6:
          ...
          if (files.length > 0) {
            ...
            files.forEach(function (file) {
              ...
              listItem.innerHTML = "<pre>".concat(JSON.stringify(file, null, 2), "</pre>");
